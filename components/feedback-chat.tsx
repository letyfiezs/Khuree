...
export function FeedbackChat() {
  ...
  useEffect(() => {
    if (typeof Notification !== "undefined") { setNotificationPermission(Notification.permission); setShowPermissionPrompt(Notification.permission === "default"); }
