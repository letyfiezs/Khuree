...
export type ContentItem = { id:string; slug:string; title:string; synopsis:string; year:number; duration:string; age:string; rating:number; genre:string[]; kind:ContentKind; status:'published'|'draft'; accent:string; episodes?:number };
